    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          {profile && !loading && !error && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-lg text-gray-800">{profile.name || 'N/A'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-lg text-gray-800">{profile.phoneNo || 'N/A'}</p>
              </div>
            </div>
          )}
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-medium transition duration-150"
            >
              Edit Profile
            </button>
            <button
              onClick={() => navigate('/')}
              className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-2 rounded-lg font-medium transition duration-150"
            >
              Back to Home
            </button>
          </div>
      ...
      {activeTab === 'orders' && (
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <Link
            to="/view-orders"
            className="inline-block bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-medium transition duration-150"
          >
            View All Orders
          </Link>
        </div>
