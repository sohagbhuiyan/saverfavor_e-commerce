...
//   const [showOrderForm, setShowOrderForm] = useState(false); // State to toggle form visibility
...
//       alert("Please log in to place an order.", { duration: 1000 });
//       navigate("/login");
//       return;
//     }
//     setShowOrderForm(true); // Show the form when the button is clicked
//   };
...
//       toast.error("Missing product information. Please try again.", { duration: 2000 });
//       return;
//     }
...
//       requestDate, // Include the request date
//       userId: user.id, // Include user ID for authentication
//     };
...
//         setOrderForm({ district: "", upazila: "", address: "" }); // Reset form
//       })
//       .catch((error) => {
